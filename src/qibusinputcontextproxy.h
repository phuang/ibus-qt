 ...
 * Command line was: qdbusxml2cpp -c InputContextAdaptor -p qibusinputcontextproxy org.freedesktop.IBus.InputContext.xml org.freedesktop.IBus.InputContext
 *
...
#ifndef QIBUSINPUTCONTEXTPROXY_H_1247800269
#define QIBUSINPUTCONTEXTPROXY_H_1247800269
 ...
 */
class InputContextAdaptor: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    InputContextAdaptor(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
namespace org {
  namespace freedesktop {
    namespace IBus {
      typedef ::InputContextAdaptor InputContext;
    }
  }
}
#endif
