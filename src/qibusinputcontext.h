...
#ifndef QIBUSINPUTCONTEXT_H_1247194720
#define QIBUSINPUTCONTEXT_H_1247194720
 ...
 */
class QIBusInputContext: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    QIBusInputContext(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
namespace org {
  namespace freedesktop {
    namespace IBus {
      typedef ::QIBusInputContext InputContext;
    }
  }
}
#endif
