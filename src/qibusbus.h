...
#ifndef QIBUSBUS_H_1247208114
#define QIBUSBUS_H_1247208114
 ...
 */
class QIBusBus: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    QIBusBus(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
